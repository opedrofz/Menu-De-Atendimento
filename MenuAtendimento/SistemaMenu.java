				    ...
				    if (opcaoMenu2 == 0) {
					    ...
					    if (escolhaEntrada >= 0 && escolhaEntrada <= 7) {
						    ...
						    System.out.println("Pedido Efetuado! Aguarde.\n");
						    	...
						    	System.out.println("Você deseja fazer outro pedido? (S/N): ");
						    	scan.nextLine();
						    ...
						    System.out.println("Ops! Não encontramos nenhum Prato! Selecione a numeração correspondente ao Prato escolhido.");
					    }
					    ...
					    if (escolhaSobremesa >= 0 && escolhaSobremesa <= 7) {
						    ...
						    System.out.println("Ops! Não encontramos nenhuma Sobremesa! Selecione a numeração correspondente a Sobremesa escolhida.");
					    }
					    ...
					    if (escolhaDrink >= 0 && escolhaDrink <= 7) {
						    ...
						    System.out.println("Ops! Não encontramos nenhum Drink! Selecione a numeração correspondente ao Drink escolhido.");
					    }   
					    ...
					    if (escolhaBebidas >= 0 && escolhaBebidas <= 7) {
						    ...
						    System.out.println("Ops! Não encontramos nenhuma Bebida! Selecione a numeração correspondente a Bebida escolhida.");
					    }
				    }
