				...
				menu2: while (repetir) {
					...
					if (opcaoMenu2 == 0) {
						...
						for (int j = 0; j < entradas.length; j++) {
							System.out.printf("[" + j + "]" + " - " + "%-20s R$ %6.2f%n", entradas[j],
									valorEntradas[j]);
						}

						System.out.println("\nInsira o Prato de Entrada desejado que notificaremos o garçom."); // ESCOLHA
																												// DO
						// PRATO
						// PELO CLIENTE
						...
						for (int j = 0; j < principal.length; j++) {
							System.out.printf("[" + j + "]" + " - " + "%-20s R$ %6.2f%n", principal[j],
									valorPrincipal[j]);
						}
						System.out.println("");
						System.out.println("Insira o Prato Principal desejado que notificaremos o garçom."); // ESCOLHA
																												// DO
																												// PRATO
																												// PELO
																												// CLIENTE
						...
						for (int j = 0; j < sobremesas.length; j++) {
							System.out.printf("[" + j + "]" + " - " + "%-20s R$ %6.2f%n", sobremesas[j],
									valorSobremesas[j]);
						}

						System.out.println("");
						System.out.println("Insira a Sobremesa desejado que notificaremos o garçom."); // ESCOLHA DA
																										// SOBREMESA
																										// PELO
																										// CLIENTE
						...
						System.out.println("\nInsira o Drink desejado que notificaremos o garçom."); // ESCOLHA DOS
																										// DRINKS DO
																										// CLIENTE
						...
						System.out.println("\nInsira a Bebida desejado que notificaremos o garçom."); // ESCOLHA DAS
																										// BEBIDAS DO
																										// CLIENTE
